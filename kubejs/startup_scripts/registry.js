...
onEvent("block.registry", (event) => {
  ...
  //必须在这里注册2个下界传送门框架 因为 → startup_scripts/disable_portal.js #10
...
onEvent("fluid.registry", (event) => {
  let undef1ned_fluid = event.create("undef1ned_fluid").displayName("Fluid of Creation").stillTexture("kubejs:fluid/undef1ned_fluid").flowingTexture("kubejs:fluid/undef1ned_fluid")
