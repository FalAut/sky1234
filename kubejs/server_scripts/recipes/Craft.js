onEvent('recipes', (event) => {
    ...
    shapeless('9x ae2:fluix_pearl', 'kubejs:fluix_pearl_block')
    shapeless('9x botania:mana_pearl', 'kubejs:mana_pearl_block')
    shapeless('9x occultism:spirit_attuned_gem', 'kubejs:spirit_attuned_gem_block')
    shapeless('9x assemblylinemachines:pure_iron_ingot', 'kubejs:pure_iron_block')
