...
onEvent("ponder.registry", (event) => {
  event.create("naturesaura:wood_stand").scene("tree_ritual", "Tree Ritual", "tree_ritual", (scene, util) => {
    ...
    //放置木基座物品
    scene.text(100, "Firstly, place the items needed for the ritual on the Wooden Stand.The order of placement is arbitrary").attachKeyFrame();
    let WoodStandPos = [
      [7, 1, 1],
      [8, 1, 4],
      [7, 1, 7],
    ...
    //进行仪式
    scene
      .text(100, "If the placed items are correct, the ritual will begin and consume the Golden Powder, Tree, and Items on the Wooden Stand")
      .attachKeyFrame();
    //清除物品
