...
onEvent("ponder.registry", (event) => {
  ...
  event.create("naturesaura:nature_altar").scene("altar", "Nature Altar", "altar", (scene, util) => {
    ...
    scene
      .text(100,"Place the items that need to be poured into the Natural Altar, and if there is enough Aura in the Natural Altar, the items in it will be Aura infused")
      .colored("green")
      .attachKeyFrame();
  ...
  event.create("naturesaura:nature_altar").scene("nether_altar", "Crimson Altar", "nether_altar", (scene, util) => {
    ...
    scene
      .text(80,"The use of the Crimson Altar is not much different from the Natural Altar, the Crimson Altar can collect the Aura of the Nether and pour it into the item")
      .attachKeyFrame()
      .colored("red");
    //金锭→污染黄金
