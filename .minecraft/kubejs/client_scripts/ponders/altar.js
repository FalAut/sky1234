...
onEvent("ponder.registry", (event) => {
  //第一个场景 - 自然祭坛
  event
    .create(["naturesaura:nature_altar", "naturesaura:conversion_catalyst", "naturesaura:crushing_catalyst"])
    .scene("altar", "Nature Altar", "altar", (scene, util) => {
      ...
      scene
        .text(
          40,
          "After the altar is built, it slowly absorbs the surrounding Aura and deposits it into the Natural Altar"
        )
        .colored("green")
        .attachKeyFrame()
      scene.idle(50)
      ...
      scene
        .text(200, "After the catalyst is placed, the natural altar will have more Recipe")
        .colored("green")
        .attachKeyFrame()
      //嬗变催化器 木炭→煤炭
  ...
  event
    .create(["naturesaura:nature_altar", "naturesaura:conversion_catalyst", "naturesaura:crushing_catalyst"])
    .scene("nether_altar", "Crimson Altar", "nether_altar", (scene, util) => {
      scene.scaleSceneView(0.8)
      scene.showStructure()
      scene.idle(20)
      ...
      scene
        .text(
          40,
          "The Crimson Altars can also use catalysts, and Catalyst placed on the Nether will change its texture"
        )
        .attachKeyFrame()
        .colored("red")
        .placeNearTarget()
