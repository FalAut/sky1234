onEvent("recipes", (event) => {
  ...
  immersiveengineeringCokeOven("immersiveengineering:coal_coke", "coal")
    .creosote(100)
    .time(20)
    .id(`${id_prefix}coal_coke`)
  immersiveengineeringCokeOven("thermal:coal_coke_block", "coal_block")
    .creosote(900)
    .time(180)
    .id(`${id_prefix}coal_coke_block`)
  immersiveengineeringBlastFurnace(
    "immersiveengineering:ingot_steel",
    "kubejs:ferro_coke_blend",
    "immersiveengineering:slag"
  )
    .time(20)
    .id(`${id_prefix}ingot_steel`)
  immersiveengineeringArcFurnace("2x thermal:obsidian_glass", "ae2:quartz_glass", [
    "minecraft:obsidian",
    "minecraft:quartz",
  ]).id(`${id_prefix}obsidian_glass`)
  immersiveengineeringArcFurnace("4x pipez:item_pipe", "minecraft:dropper", ["2x thermal:cured_rubber"]).id(
    `${id_prefix}item_pipe`
  )
  immersiveengineeringArcFurnace("4x pipez:fluid_pipe", "minecraft:bucket", ["2x thermal:cured_rubber"]).id(
    `${id_prefix}fluid_pipe`
  )
  immersiveengineeringArcFurnace("4x pipez:energy_pipe", "immersiveengineering:wirecoil_copper", [
    "2x thermal:cured_rubber",
  ...
  immersiveengineeringMetalPress("thermal:diamond_gear", "4x diamond", "immersiveengineering:mold_gear").id(
