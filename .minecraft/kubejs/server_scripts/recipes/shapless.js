...
onEvent('recipes', event => {
    ...
    minecraft.crafting_shapeless(Item.of('create:sand_paper', '{Damage:0,Unbreakable:1b}'), ['minecraft:paper', 'minecraft:sand']).id(`${id_prefix}sand_paper`);
    minecraft.crafting_shapeless('architects_palette:oracle_jelly', ['minecraft:chorus_fruit', 'minecraft:amethyst_shard', 'minecraft:sugar', 'minecraft:shulker_shell']).id(`${id_prefix}oracle_jelly`);
    ...
    minecraft.crafting_shapeless('tiab:time_in_a_bottle', ['minecraft:glass_bottle', 'naturesaura:clock_hand']).id(`${id_prefix}time_in_a_bottle`);
    minecraft.crafting_shapeless('naturesaura:token_rage', ['naturesaura:token_anger', Item.of('naturesaura:aura_bottle', '{stored_type:"naturesaura:nether"}')]).id(`${id_prefix}token_rage`);
    ...
    minecraft.crafting_shapeless('occultism:chalk_purple_impure', ['occultism:chalk_white_impure', 'purple_dye']).id(`${id_prefix}chalk_purple_impure`);
    minecraft.crafting_shapeless('64x hostilenetworks:overworld_prediction', 'hostilenetworks:empty_prediction').id(`${id_prefix}overworld_prediction`);
