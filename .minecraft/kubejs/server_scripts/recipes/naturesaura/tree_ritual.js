onEvent('recipes', event => {
    ...
    const recipes = [
        ...
        },
        {
            ...
            'naturesaura:token_joy','cobblestone','cobblestone'
            ],
        ...
        {
            ingredients: [//N S W E NW SE NE SW
            'naturesaura:infused_iron','naturesaura:token_euphoria','naturesaura:infused_stone','naturesaura:infused_stone',
            'naturesaura:gold_brick','naturesaura:gold_brick','naturesaura:gold_brick','naturesaura:gold_brick'
            ],
        ...
        {
            ingredients: [//N S W E NW SE NE SW
            'compactcrafting:projector_dish','compactcrafting:base','kubejs:infused_coal',
        ...
        {
            ingredients: [//N S W E NW SE NE SW
            Item.of('naturesaura:aura_bottle', '{stored_type:"naturesaura:overworld"}'),'naturesaura:gold_leaf','minecraft:iron_ingot','minecraft:iron_ingot'
            ],
