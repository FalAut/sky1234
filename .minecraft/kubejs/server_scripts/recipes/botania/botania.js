onEvent("recipes", (event) => {
  ...
  const { mana_infusion, elven_trade, pure_daisy, brew, petal_apothecary, runic_altar, terra_plate, orechid, orechid_ignem, marimorphosis } = event.recipes.botania
  ...
  mana_infusion("botania:mana_diamond_block", "kubejs:spirit_attuned_gem_block", 90000).id(`${id_prefix}mana_diamond_block`)
