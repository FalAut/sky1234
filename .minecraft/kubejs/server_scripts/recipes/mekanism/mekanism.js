...
onEvent("recipes", (event) => {
  ...
  metallurgic_infusing(
    "assemblylinemachines:empowered_coal",
    "minecraft:coal",
    "20x mekanism:redstone"
  ).id(`${id_prefix}empowered_coal`);
  ...
  crushing(
    "assemblylinemachines:prismatic_dust",
    "assemblylinemachines:prism_rose"
  ).id(`${id_prefix}prismatic_dust`);
