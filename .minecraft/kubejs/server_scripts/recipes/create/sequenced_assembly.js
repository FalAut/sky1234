...
//Queens Slime Ingot
	...
	]).transitionalItem(t).loops(1).id(`${id_prefix}queens_slime_ingot`)
...
//Tainted Blend
	...
	sequenced_assembly([
		...
		pressing(t, t),
		cutting(t, t)
	]).transitionalItem(t).loops(1).id(`${id_prefix}tainted_blend`)
...
//Precision Mechanism
	...
	]).transitionalItem(t).loops(1).id(`${id_prefix}precision_mechanism`)
...
//rs_engineering
    ...
    sequenced_assembly('immersiveengineering:rs_engineering', t, [
        ...
        pressing(t, [t, t])
    ]).transitionalItem(t).loops(1).id(`${id_prefix}rs_engineering`)
...
//light_engineering
    ...
    sequenced_assembly('immersiveengineering:light_engineering', t, [
		...
		deploying(t, [t, 'create:electron_tube']),
        pressing(t, [t, t])
    ]).transitionalItem(t).loops(1).id(`${id_prefix}light_engineering`)
...
//heavy_engineering
    ...
    sequenced_assembly('immersiveengineering:heavy_engineering', t, [
		...
		deploying(t, [t, 'create:electron_tube']),
        pressing(t, [t, t])
    ]).transitionalItem(t).loops(1).id(`${id_prefix}heavy_engineering`)
...
//generator
    ...
    sequenced_assembly('immersiveengineering:generator', t, [
        ...
        pressing(t, [t, t])
    ]).transitionalItem(t).loops(1).id(`${id_prefix}generator`)
...
//radiator
    ...
    sequenced_assembly('immersiveengineering:radiator', t, [
        ...
        pressing(t, [t, t])
    ]).transitionalItem(t).loops(1).id(`${id_prefix}radiator`)
...
//component_electronic
    ...
    sequenced_assembly('immersiveengineering:component_electronic', t, [
        ...
        deploying(t, [t, 'immersiveengineering:screwdriver']).keepHeldItem()
    ]).transitionalItem(t).loops(1).id(`${id_prefix}component_electronic`)
...
//electron_tube
    ...
    sequenced_assembly('3x immersiveengineering:electron_tube', '#forge:glass', [
        ...
        deploying(t, [t, 'immersiveengineering:screwdriver']).keepHeldItem()
    ]).transitionalItem(t).loops(1).id(`${id_prefix}electron_tube`)
...
// Creative Motor
    ...
    sequenced_assembly('create:creative_motor', t, [
        deploying(t, [t, 'tconstruct:queens_slime_ingot'])
    ]).transitionalItem(t).loops(1024).id(`${id_prefix}creative_motor`)


// RF Coil
    t = 'kubejs:incomplete_rf_coil'
    sequenced_assembly([Item.of('thermal:rf_coil').withChance(99), Item.of('torcherino:double_compressed_torcherino').withChance(1)], 'minecraft:gold_ingot', [
    ...
    ]).transitionalItem(t).loops(4).id(`${id_prefix}rf_coil`)

// Redstone Servo
    t = 'kubejs:incomplete_redstone_servo'
    sequenced_assembly([Item.of('thermal:redstone_servo').withChance(99), Item.of('torcherino:double_compressed_torcherino').withChance(1)], 'minecraft:iron_ingot', [
        deploying(t, [t, Item.of('immersiveengineering:metal_press').enchant('vanishing_curse', 100)]),
        filling(t, [t, Fluid.of('thermal:redstone', 100)]),
    ]).transitionalItem(t).loops(4).id(`${id_prefix}redstone_servo`)
...
// RF Coil Thermal
    ...
    sequenced_assembly('thermal:rf_coil', 'minecraft:gold_ingot', [
        ...
        filling(t, [t, Fluid.of('thermal:redstone', 100)]),
        filling(t, [t, Fluid.of('thermal:redstone', 100)]),
    ]).transitionalItem(t).loops(1).id(`${id_prefix}rf_coil_thermal`)
