...
onEvent("recipes", (event) => {
  ...
  immersiveengineeringArcFurnace(
    ...
    "ae2:quartz_glass",
    ["minecraft:obsidian", "minecraft:quartz"]
  ).id(`${id_prefix}obsidian_glass`);
  immersiveengineeringArcFurnace("4x pipez:item_pipe", "minecraft:dropper", [
    "2x thermal:cured_rubber",
  ]).id(`${id_prefix}item_pipe`);
  immersiveengineeringArcFurnace("4x pipez:fluid_pipe", "minecraft:bucket", [
    "2x thermal:cured_rubber",
